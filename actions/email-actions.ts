...
export const sendVerificationEmail = async (email: string) => {
  ...
  try {
    ...
    const verificationLink = `https://next-js-ecommerce-vainilla-store.vercel.app/verify-email?token=${token}&email=${email}`;
...
export const sendPasswordResetEmail = async (email: string) => {
  ...
  try {
    ...
    const resetLink = `https://next-js-ecommerce-vainilla-store.vercel.app/reset-password/verify-password?token=${token}&email=${email}`;
